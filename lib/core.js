...
// - Intuitively, I'd prefer to interpret percent-encoded bytes during parsing
// - However that would be lossy whilst the WhatWG spec requires that encoding idiosyncracies are preserved
...
// conf is either a base-scheme, or an object: { convertSlashes?, driveLetters?, baseScheme? }
// convertSlashes: true, false, (other values are ignored)
// driveLetters: true, false, (other values are ignored)
...
function url (url_string, conf) {
  ...
  return drive ? letter (pure) : pure // TODO should this be made more/ different configurable?
}


//var conf = { baseScheme:'httpsp', convertSlashes:'http' }
//var conf = { driveLetters:false } //'file'
