...
function escapeToken (tok) {
  ...
  switch (tok[0]) {
    case AUTH:
      v = auth.print (v) //wtf8.encode (v) .replace (HOST_ESC, _esc)
    break
    case FRAG:
...
// one ideal for 'goto': the ordered lists,
// and one ideal for get/set: object records. 
// What to do with this?

function _fromRec (rec) {
...
// log (steal(url('file:d:/foo'))) // FIXME
