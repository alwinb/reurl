...
class ReUrl {
  ...
  _set (type, fn_or_value) {
    return this.fromArray (core.select (this._tokens, type) .set (fn_or_value))
  }
  ...
  withHost (name, port) { // alias withAuthority
    ...
    return this.fromArray (auth .set (_ => Object.assign (_, host)))
  }
  ...
  withDrive (v) { 
    ...
    return this.fromArray (drive .set (v))
  }
  ...
  // withPath (path) {
  // }
  // TODO parse PATH instead of URL on withPath? 
  // withDirectory ?
  ...
  goto (other) {
    const _other = other instanceof ReUrl ? other._tokens
      : other == null ? [] : core.parse (String (other), this._conf)
    log ('goto', other, this._conf)
    return this.fromArray (core.join (this._tokens, _other))
  }
  ...
  resolve (other) {
    const _other = other instanceof ReUrl ? other._tokens
      : other == null ? [] : core.parse (String (other), this._conf)
    return this.fromArray (core.resolve (this._tokens, _other))
  }
  ...
  forceResolve (other) {
    const _other = other instanceof ReUrl ? other._tokens
      : other == null ? [] : core.parse (String (other), this._conf)
    return this.fromArray (core.forceResolve (this._tokens, _other))
  }
