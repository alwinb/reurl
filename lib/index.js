...
const core = require ('spec-url')
const { pct } = require ('spec-url/src/pct')
...
class Url {
  ...
  isResolved () {
    return core.isResolved (this) }

  goto (other, { strict = false } = { }) {
    other = prepare (other, this, this.scheme)
    return url (core.goto (this, other, { strict }), this) }
  ...
  preResolve (base) {
    ...
    return url (core.preResolve (this, base), this) }
  ...
  forceResolve (base) {
    base = prepare (base, this)
    return url (core.forceResolve (this, base), this) }
...
// ### instantiation
// unsafe; mutates obj into an Url or RawUrl instance
...
// unsafe; used for parsing and/or reconciling the percentCoding and/or importing
...
module.exports = { version:'1.0.0-rc', Url, RawUrl }